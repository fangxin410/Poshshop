...
- (void)main {
    ...
    @autoreleasepool {
      ...
      // NSData *imageData = [NSData dataWithContentsOfURL:self.photoRecord.URL];
        ...
        //https://d1zog42tnv16ho.cloudfront.net/5297d7df5aefb02f90ce4e3b-feed.jpg
        
        NSData *imageData = [NSData dataWithContentsOfURL:[NSURL URLWithString:self.photoRecord.URL]];
        if (self.isCancelled) {
            imageData = nil;
            return;
        }
